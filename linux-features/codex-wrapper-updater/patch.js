  ...
  try {
    ...
    if (generalSettingsAssets.length === 0) {
      return {
        matched: false,
        changed: 0,
        reason: `${KEYBINDS_ASSET}, ${LINUX_DESKTOP_SETTINGS_ASSET}, and general settings asset are not present`,
      };
    }
