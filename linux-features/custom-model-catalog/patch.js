...
const MODEL_QUERY_SHIM_HELPER_SOURCE = [
  ...
  "function codexLinuxCustomModelLegacyCatalogSlug(e){return e===`codex-auto`||/^(cursor-|zai-|minimax-|opencode-go-|opencode-zen-|xiaomi-mimo-|crof-|crofai-|commandcode-|grok-|xai-|composer-)/u.test(e)}",
...
const ROUTING_HELPER_SOURCE = [
  ...
  "function codexLinuxCustomModelLegacyShimSlug(e){return e===`codex-auto`||/^(cursor-|zai-|minimax-|opencode-go-|opencode-zen-|xiaomi-mimo-|crof-|crofai-|commandcode-|grok-|xai-|composer-)/u.test(e)}",
  "function codexLinuxCustomModelCustomSlug(e){let t=codexLinuxCustomModelSlugKey(e);return globalThis.__codexLinuxCustomModelSlugs?.has(t)===!0||codexLinuxCustomModelLegacyShimSlug(t)}",
  "function codexLinuxCustomModelProviderForSlug(e){let t=codexLinuxCustomModelSlugKey(e);if(!t)return null;let n=globalThis.__codexLinuxCustomModelProviders?.get(t);return typeof n==`string`&&n.trim().length>0?n.trim():codexLinuxCustomModelCustomSlug(t)?`codex_shim`:null}",
  ...
  "function codexLinuxCustomModelApplyRouting(e,t){if(!codexLinuxCustomModelCustomSlug(t))return e;let n=codexLinuxCustomModelSlugKey(t),r=codexLinuxCustomModelProviderForSlug(t)??`codex_shim`,i=globalThis.__codexLinuxCustomModelCatalogPaths?.get(n),a=globalThis.__codexLinuxCustomModelRuntimeConfig?.get(n)??{},o={...e.config,model:t,model_provider:r,...a,...(i==null?{}:{model_catalog_json:i})},s=codexLinuxCustomModelProviderConfig(r);s&&(o[`model_providers.${r}`]={...s,...e.config?.[`model_providers.${r}`]});return{...e,model:t,modelProvider:r,config:o}}",
