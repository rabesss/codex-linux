...
const ROUTING_HELPER_SOURCE = [
  ...
  "function codexLinuxCustomModelApplyRouting(e,t){if(!codexLinuxCustomModelCustomSlug(t))return e;let n=codexLinuxCustomModelSlugKey(t),r=codexLinuxCustomModelProviderForSlug(t);if(r==null)return e;let i=globalThis.__codexLinuxCustomModelCatalogPaths?.get(n),a=globalThis.__codexLinuxCustomModelRuntimeConfig?.get(n)??{},o={...e.config,model:t,model_provider:r,...a,...(i==null?{}:{model_catalog_json:i})},s=codexLinuxCustomModelProviderConfig(r);s&&(o[`model_providers.${r}`]={...s,...e.config?.[`model_providers.${r}`]});return{...e,model:t,modelProvider:r,config:o}}",
