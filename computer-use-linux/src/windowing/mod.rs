...
mod tests {
    ...
    fn resolves_terminal_target_by_tty() {
        let windows = vec![
            ...
            terminal_window(2, "Codex", "/dev/pts/1", 201, "codex", "/home/user"),
        ];
    ...
    fn resolves_terminal_target_by_cwd_suffix() {
        let windows = vec![
            terminal_window(1, "Home", "/dev/pts/0", 101, "zsh", "/home/user"),
            terminal_window(
                2,
                "Project",
                "/dev/pts/1",
                201,
                "codex",
                "/home/user/projects/codex-desktop-control",
            ),
        ];
        ...
        let matched = resolve_window_target(
            &windows,
            &WindowTarget {
                terminal_cwd: Some("projects/codex-desktop-control".to_string()),
                ..Default::default()
            },
        )
        .unwrap();
    ...
    fn terminal_target_reports_ambiguous_matches() {
        let windows = vec![
            terminal_window(1, "One", "/dev/pts/0", 101, "zsh", "/home/user"),
            terminal_window(2, "Two", "/dev/pts/1", 201, "zsh", "/home/user"),
        ];
