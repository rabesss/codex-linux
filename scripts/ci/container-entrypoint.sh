...
run_deb_job() {
    ...
    assert_not_contains_file /tmp/deb-no-updater-contents.txt './usr/share/polkit-1/actions/com.github.codex-desktop-control.update.policy'
...
run_rpm_job() {
    ...
    assert_not_contains_file /tmp/rpm-no-updater-contents.txt '/usr/share/polkit-1/actions/com.github.codex-desktop-control.update.policy'
...
run_pacman_job() {
    ...
    assert_not_contains_file /tmp/pacman-no-updater-contents.txt 'usr/share/polkit-1/actions/com.github.codex-desktop-control.update.policy'
